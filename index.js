  ...
  useUnifiedTopology: true
    ...
    client => {
        ...
        app.post(
            '/addSession',
            (req,res) => {
                sessionCollection.insertOne(req.body).
                then(result => {
                    res.send(result);
                }).
        ...
        app.post(
            '/getSession',
            (req,res) => {
                sessionCollection.find().toArray().
                then(result => {
                    res.send(result);
                }).
                catch(error => res.send(error))
        ...
        app.post(
            ...
            (req,res) => {
                sessionCollection.updateOne(
                    ...
                    { $set: {
                            ["students."+req.body.regno+".courses."+req.body.course.courseID]: req.body.course 
                        }
                    }
                ).then(result => {
                    res.send(result);
        ...
        app.post(
            ...
            (req,res) => {
                sessionCollection.updateOne(
                    ...
                    { $set: {
                            ["students."+req.body.regno+".courses."+req.body.courseid+".reattempt."+req.body.reattempt.level]: req.body.reattempt 
                        }
                    }
                ).then(result => {
                    res.send(result);
